...
public abstract class DragDropTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    public void startDrag() {
        ...
        itemHeight = viewUnder.getHeight();
    ...
    private void switchViewsIfNeeded() {
        ...
        recyclerView.getLocationOnScreen(locations);
        int mobileViewY = (int) mobileView.getY() - locations[1];
     ...
     * @param to           new drag position within adapter
     */
