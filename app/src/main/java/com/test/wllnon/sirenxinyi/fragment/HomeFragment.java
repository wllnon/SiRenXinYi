...
import com.test.wllnon.sirenxinyi.activity.QuestionEditActivity;
...
public class HomeFragment extends Fragment
    ...
    /**
     * @author wllnon
     * @timer 2016/2/21 15:12
     * @func Contains the card-data list which pushed from the network.
     */
    ...
    private void findViews(View rootView) {
        swipeRefreshLayout = (SwipeRefreshLayout) rootView.findViewById(R.id.swipe_refresh_layout_home);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_view_home);
        floatingActionButton = (FloatingActionButton) rootView.findViewById(R.id.fab_home);
    }
    ...
    private void setListeners() {
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), QuestionEditActivity.class));
            }
        });
    }
    ...
    @Override
    public void onItemClick(RecyclerView parent, View clickView, int position) {
    }
    ...
    public void onRefresh() {
        Application.getInstance().getNetworkUtils().gsonRequest(HomeFragment.this,
    ...
    /**
     * @author wllnon
     * @timer 2016/2/21 15:33
     * @func update the data from the network. Here I just initialed the datalist
     */
    ...
    // public class HomeRecyclerAdapter extends RecyclerView.Adapter<BaseCardViewHolder> {
    public class HomeRecyclerAdapter extends RecyclerViewAdapter<BaseCardViewHolder> {
