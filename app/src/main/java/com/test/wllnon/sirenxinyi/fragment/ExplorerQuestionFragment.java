 ...
 */
public class ExplorerQuestionFragment extends BaseTabFragment
    ...
    public ExplorerQuestionFragment() {
        title = "Question";
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_question_explorer, container, false);
    ...
    private void findViews(View rootView) {
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_view_question);
        swipeRefreshLayout = (SwipeRefreshLayout) rootView.findViewById(R.id.swipe_refresh_layout_question);
    }
    ...
    private void configViews() {
        ...
        adapter = new QuestionRecyclerViewAdapter();
    ...
    public void onItemLongClick(RecyclerView parent, View clickView, int position) {
        // TODO: 2016/4/13 nothing need to be done
    ...
    public void onRefresh() {
        Application.getInstance().getNetworkUtils().gsonRequest(ExplorerQuestionFragment.this,
    ...
    public class QuestionRecyclerViewAdapter extends RecyclerViewAdapter<BaseCardViewHolder> {
                        ...
                        new Response.Listener<List<BaseCardData>>() {
                            ...
                            public void onResponse(List<BaseCardData> response) {
                                if (response == null || response.size() <= 0) {
                                    ...
                                    cardData.setQuestion(question);
                                    cardData.setUser(user);
                                    adapter.insertItem(cardData, dataList.size());
                                }
