...
public class FriendFellowFragment extends BaseTabFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_fellow_friend, container, false);
    ...
    private void findViews(View rootView) {
        swipeRefreshLayout = (SwipeRefreshLayout) rootView.findViewById(R.id.swipe_refresh_layout_fellow);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_view_fellow);
    }
    ...
    private void configViews() {
        ...
        adapter = new FellowRecyclerAdapter();
    ...
    public class FellowRecyclerAdapter extends RecyclerViewAdapter<BaseCardViewHolder> {
