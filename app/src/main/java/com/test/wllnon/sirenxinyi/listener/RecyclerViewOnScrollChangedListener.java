 ...
 */
public class RecyclerViewOnScrollChangedListener extends RecyclerView.OnScrollListener {

    // region Member Variables
    private final ScrollViewOnScrollChangedListener.ViewType mQuickReturnViewType;
    ...
    // region Constructors
    private RecyclerViewOnScrollChangedListener(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(ScrollViewOnScrollChangedListener.ViewType quickReturnViewType) {
        ...
        public RecyclerViewOnScrollChangedListener build() {
            return new RecyclerViewOnScrollChangedListener(this);
        }
    }
